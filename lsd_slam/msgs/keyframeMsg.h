...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'lsd_slam_viewer': ['/home/oakyildiz/workspaces/ros_workspace/src/lsd_slam/lsd_slam_viewer/msg']}
...
struct MD5Sum< ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator> >
{
  ...
  {
    return "db0a795065d8e05013b43054a0c4cb01";
  }

  static const char* value(const ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xdb0a795065d8e050ULL;
  static const uint64_t static_value2 = 0x13b43054a0c4cb01ULL;
};
